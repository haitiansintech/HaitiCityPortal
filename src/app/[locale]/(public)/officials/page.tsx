                        ...
                        filteredOfficials.map((official) => (
                            <Card key={official.id} className="rounded-3xl border-weak shadow-sm hover:shadow-md transition-all overflow-hidden bg-white group">
                                ...
                                <CardContent className="p-6 space-y-4">
                                    ...
                                    {(official as any).vwa_profile_url && (
                                        <Button asChild variant="outline" className="w-full rounded-2xl border-blue-200 text-blue-700 hover:bg-blue-50 hover:text-blue-800 font-semibold mb-2 group">
                                            <a
                                                href={(official as any).vwa_profile_url}
                                                target="_blank"
                                                rel="noreferrer"
                                                className="flex items-center justify-center gap-2"
                                            >
                                                <BadgeCheck className="h-5 w-5 fill-blue-100 text-blue-600" />
                                                View Verified Profile on Vwa
                                            </a>
                                        </Button>
                                    )}
