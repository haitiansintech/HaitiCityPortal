...
import { ShieldCheck, TrendingUp, DollarSign, Youtube } from "lucide-react";
            ...
            <div className="max-w-7xl mx-auto space-y-12">
                <div className="text-center max-w-2xl mx-auto">
                    ...
                    <div className="inline-flex">
                        <a
                            href="https://youtube.com/@CityHallJacmel"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-2 px-5 py-2.5 bg-red-600 text-white rounded-full font-bold hover:bg-red-700 transition-colors shadow-sm"
                        >
                            <Youtube className="h-5 w-5" />
                            <span>Watch Town Hall Recordings</span>
                        </a>
                    </div>
                </div>
