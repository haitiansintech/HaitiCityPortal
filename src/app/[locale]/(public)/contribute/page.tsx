...
import { Github, Heart, Users, Shield, Code2 } from "lucide-react";
            ...
            <div className="max-w-5xl mx-auto space-y-20">
                ...
                <section className="bg-slate-900 text-white rounded-[2rem] p-8 md:p-12 overflow-hidden relative">
                    <div className="relative z-10 max-w-2xl">
                        ...
                        <h2 className="text-3xl font-bold mb-6">{t("devTitle")}</h2>
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <Button variant="secondary" asChild className="bg-emerald-600 hover:bg-emerald-700 text-white border-0">
                                <Link href="/about/tech">{t("devManifesto")}</Link>
                            </Button>
                        </div>
                    </div>
                </section>
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="order-2 md:order-1">
                        ...
                        <h2 className="text-3xl font-bold text-ink-primary mb-4">{t("citizensTitle")}</h2>
                        <h3 className="text-xl font-semibold text-ink-secondary mb-4">{t("citizensSubtitle")}</h3>
                        ...
                        <ol className="space-y-4 mb-8">
                            <li className="flex gap-3">
                                ...
                                <span>{t.rich("citizensStep1", { strong: (chunks) => <strong>{chunks}</strong> })}</span>
                            </li>
                            <li className="flex gap-3">
                                <span className="font-bold text-brand-blue">2.</span>
                                <span>{t.rich("citizensStep2", { strong: (chunks) => <strong>{chunks}</strong> })}</span>
                            </li>
                        </ol>
                ...
                <section className="bg-white border border-gray-200 rounded-[2rem] p-8 md:p-12 shadow-sm">
                    <div className="flex flex-col md:flex-row gap-8 items-start md:items-center">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold text-ink-primary mb-2">{t("officialsTitle")}</h2>
                            <p className="text-ink-secondary mb-6">
                                {t("officialsDesc")}
                            </p>
                            <Button variant="outline" asChild>
                                <a href="mailto:partners@haiticity.org">{t("officialsDemo")}</a>
                            </Button>
                        </div>
                    </div>
                </section>
